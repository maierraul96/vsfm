...
{
    public partial class FormEditorModifica : Form
    {
        //Declaratii baza de date
        OleDbConnection DBConnection = new OleDbConnection(); //Conexiune
       // OleDbDataAdapter ADAdapter;
        public DataTable Intrebare = new DataTable();
        ...
        {
            Image FetchedImage;
            byte[] FetchedBytes = (byte[])(Intrebare.Rows[0][denumireCamp]);
        ...
        private void displayIntrebare()
        {
            ...
            comboBoxNivel.SelectedItem = getNivelFromID(Convert.ToInt32(Intrebare.Rows[0]["Nivel"]));
            comboBoxAn.SelectedItem = getAnFromID(Convert.ToInt32(Intrebare.Rows[0]["AnStudiu"]));
            comboBoxSpecializare.SelectedItem = getSpecializareFromID(Convert.ToInt32(Intrebare.Rows[0]["Specializare"]));
            comboBoxDisciplina.SelectedItem = getDisciplinaFromID(Convert.ToInt32(Intrebare.Rows[0]["Disciplina"]));
            comboBoxMaterie.SelectedItem = getMaterieFromID(Convert.ToInt32(Intrebare.Rows[0]["Materie"]));
            comboBoxCapitol.SelectedItem = getCapitolFromID(Convert.ToInt32(Intrebare.Rows[0]["Capitol"]));
            ...
            raspunsCorect = Convert.ToInt32(Intrebare.Rows[0]["RaspunsCorect"]);
        ...
        private void StoreData()
        {
            ...
            try
            {
                ...
                string query = "UPDATE Intrebari Set Nivel=" + IDNivel + ", AnStudiu=" + IDAn + ", Specializare=" + IDSpecializare + ", Disciplina=" + IDDisciplina + ", Materie=" + IDMaterie + ", Capitol=" + IDCapitol+", ";
                query+= "Intrebare=@ImgEn, Rasp1=@ImgR1, Rasp2=@ImgR2, Rasp3=@ImgR3, Rasp4=@ImgR4, RaspunsCorect="+IDRaspC+" ";
                query += "WHERE ID="+Intrebare.Rows[0]["ID"].ToString();
